...
public class CountryStateHandler extends LocaleBotStateHandler {
    ...
    public CountryStateHandler(LocalMessageSource localMessageSource, CountryKeyboard keyboard, LocalAnswer localBotMessage) {
    ...
    public String handle(Long userId, String callback, UserData userData) {
        ...
        if (currentState == State.COUNTRY_TO) userData.setCountryFrom(callback);
        else {
