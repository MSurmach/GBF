...
public class ConstantUtil {
    ...
    public static final String MENTION_TO_USER_PATTERN = "@%s";
    ...
    public final static String SEATS_COURIER_CODE = "seats.courier";
    public final static String SEATS_CLIENT_CODE = "seats.client";
    public final static String SEATS_INFO_CODE = "seats.info";

    //    success message type
    public final static String SUCCESS_CODE = "registration.success";
    //wrong input message type
