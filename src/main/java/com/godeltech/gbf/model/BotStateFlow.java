...
public enum BotStateFlow {
    ...
    //    COURIER(COUNTRY_FROM, CITY_FROM, COUNTRY_TO, CITY_TO, YEAR_FROM, MONTH_FROM, DAY_FROM, YEAR_TO, MONTH_TO, DAY_TO, LOAD, CONFIRM, SUCCESS),
    COURIER(COUNTRY_FROM, CITY_FROM, COUNTRY_TO, CITY_TO, DATE_FROM, DATE_TO, LOAD, CONFIRM, SUCCESS),
